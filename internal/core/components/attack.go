...
func (c *AttackComponent) TryAttack(id types.Entity, pos, dir geometry.Vec3) (*events.AttackEvent, bool) {
	isAttack := dir.Length() < 2 && c.currentAttackCooldown == 0
	if isAttack {
		c.hitbox.ChangeCenter(pos.Add(dir.Scale(c.attackRange)))
